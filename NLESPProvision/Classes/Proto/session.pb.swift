...
struct Espressif_SessionData {
    ...
    var sec0: Espressif_Sec0Payload {
        get {
            if case let .sec0(v)? = proto { return v }
    ...
    var sec1: Espressif_Sec1Payload {
        get {
            if case let .sec1(v)? = proto { return v }
    ...
    var sec2: Espressif_Sec2Payload {
        get {
            if case let .sec2(v)? = proto { return v }
    ...
    enum OneOf_Proto: Equatable {
        ...
        static func == (lhs: Espressif_SessionData.OneOf_Proto, rhs: Espressif_SessionData.OneOf_Proto) -> Bool {
            ...
            case (.sec0, .sec0): return {
                    guard case let .sec0(l) = lhs, case let .sec0(r) = rhs else { preconditionFailure() }
                    return l == r
                }()
            case (.sec1, .sec1): return {
                    guard case let .sec1(l) = lhs, case let .sec1(r) = rhs else { preconditionFailure() }
                    return l == r
                }()
            case (.sec2, .sec2): return {
                    guard case let .sec2(l) = lhs, case let .sec2(r) = rhs else { preconditionFailure() }
                    return l == r
                }()
...
extension Espressif_SessionData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 12: try {
                    ...
                    if let current = self.proto {
                        hadOneofValue = true
                        if case let .sec2(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if secVer != .secScheme0 {
            try visitor.visitSingularEnumField(value: secVer, fieldNumber: 2)
        }
        switch proto {
        case .sec0?: try {
                guard case let .sec0(v)? = self.proto else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
            }()
        case .sec1?: try {
                guard case let .sec1(v)? = self.proto else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
            }()
        case .sec2?: try {
                guard case let .sec2(v)? = self.proto else { preconditionFailure() }
